...
def train_neural_network(session, optimizer, keep_probability, feature_batch, label_batch):
	...
	input_layer = np.reshape(feature_batch, [-1, image_size, image_size, image_channel])
...
image_channel = 1
number_clases = 12
x = neural_net_image_input((image_size,image_size,image_channel))
y = neural_net_label_input(number_clases)
